        ...
        <div style="background: #FFF;padding: 2vw;">
            ...
            <div style="border: 1px solid #F8F8FF;padding: 2vw;margin-top: 2vh">
                ...
                <el-upload :on-change="change" action="#" :show-file-list="false">
                    <el-button type="warning">上传发票</el-button>
                </el-upload>
                ...
                <div style="">
                    <el-button type="warning"  @click="tianjiapingzheng(0)">生成凭证</el-button>
                    <el-button type="warning"  @click="tianjiapingzheng(1)">生成凭证和流水</el-button>
                    <el-button type="warning"  @click="pipeixianyoupingzheng">匹配至现有凭证</el-button>
                    <el-button type="warning"  @click="pipeixianyouliushui">匹配至现有流水</el-button>
                </div>
                <div style="margin-top: 3vh">



                    <el-button type="warning"  @click="submitForm('form')">仅保存</el-button>

                    <el-button type="info" style="" @click="$router.push({path:'/home'})">取消</el-button>
...
<script>
    export default {
        ...
        methods: {
            ...
            tianjiapingzheng(type){
                this.$router.push({path: "/home/fapiao/tianjiapingzheng"})
            },
            pipeixianyoupingzheng(){
                this.$router.push({path: "/home/fapiao/pipeixianyoupingzheng"})

            },
            pipeixianyouliushui(){
                this.$router.push({path: "/home/fapiao/pipeixianyouliushui"})
